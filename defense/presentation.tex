		...
		\begin{column}[T]{2.25in}
			...
			\onslide<1>{
				\begin{picture}(0,0)(0,0)
					\put(0,-180)
					{\includegraphics[width=1.25in]{coulter_patent_drawing}}
				\end{picture}
			}
...
\begin{frame}[c]{Magnitude of the deformation response}
	...
	\begin{columns}[t]
		\begin{column}[T]{1.3in}
			\includegraphics[width=1.3in]{deform1.png}
			\includegraphics[width=1.3in]{deform4.png}
			\includegraphics[width=1.3in]{deform7.png}
		\end{column}
		
		\begin{column}[T]{1.3in}
			\includegraphics[width=1.3in]{deform2.png}
			\includegraphics[width=1.3in]{deform5.png}
			\includegraphics[width=1.3in]{deform8.png}
		\end{column}
		
		\begin{column}[T]{1.3in}
			\includegraphics[width=1.3in]{deform3.png}
			\includegraphics[width=1.3in]{deform6.png}
		\end{column}
...
\begin{frame}[c]{Axial position versus aspect ratio}
	...
	\begin{column}[T]{2.25in}
		{\centering
			\includegraphics[width=3in]{position-aspect.png} \\
			\par
		}
	\end{column}
