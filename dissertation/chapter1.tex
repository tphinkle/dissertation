...
\chapter{Introduction}
	...
	\section{Nanopore science---physics and chemistry}
		...
		\subsection{Surface conductance}
			...
			\begin{equation} \label{eq:dukhin}
				\frac{2\left(1+3m/z^{2}\right)}{\kappa a}\left(\cosh\frac{ze\zeta}{2k_{B}T}-1\right),
		...
		\subsubsection{Electrophoresis}
			...
			Electrophoresis is the transport of a charged species in the presence of an electric field. On the one hand this effect is intuitive; charged objects experience forces in electric fields. On the other, we know that an EDL forms in the vicinity of a particle which screens the total charge. If we draw a box around the particle and its associated EDL, it has no net charge, and will therefore experience no force. How do we explain electrophoresis?
