...
\label{chap:sin}
	...
	\section{Experimental results}
		...
		A number of conductor-insulator pores were tested, along with plain SiN pores to test if the pores intrinsically rectify the current (e.g.~due to a geometrical asymmetry).
